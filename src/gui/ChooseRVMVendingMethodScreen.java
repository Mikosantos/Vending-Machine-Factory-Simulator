...
public class ChooseRVMVendingMethodScreen extends JFrame {
    ...
    public ChooseRVMVendingMethodScreen(){
    ...
    public void init(){
        ...
        ArrayList<String> rvmVendingAcr = new ArrayList<>();
        rvmVendingAcr.add("SEE ITEM INVENTORY");
        rvmVendingAcr.add("PAY");
        rvmVendingAcr.add("DISPENSE ITEM");
        rvmVendingAcr.add("GET THE CHANGE");
        rvmVendingAcr.add("KNOW CALORIE AMOUNT");
        rvmVendingAcr.add("EXIT");

        int vmFeaturesCount = 6;
        btnRVMFeatures = new ArrayList<>(vmFeaturesCount);

        for (int i = 0; i < vmFeaturesCount; i++){
            JButton button = new JButton(rvmVendingAcr.get(i));
